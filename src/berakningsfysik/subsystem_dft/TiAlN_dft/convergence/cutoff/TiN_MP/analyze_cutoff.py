...
for path in Path("results").glob("scf_TiN_ecut*.out"):		# .glob(...) hittar alla filer vars namn börjar med scf_TiN_ecut och slutar med .out
...
out_csv = "TiN_cutoff_convergence.csv"
